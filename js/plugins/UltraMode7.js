...
be changed at any time during the map. Following script calls are available:

UltraMode7.setFov(DEGREES)
UltraMode7.setPitch(DEGREES)
UltraMode7.setYaw(DEGREES)
UltraMode7.setCamera(Z_DISTANCE)

You can also obtain the current values with these script calls:

UltraMode7.getFov()
UltraMode7.getPitch()
UltraMode7.getYaw()
UltraMode7.getCamera()
...
UltraMode7.animateCamera(TARGET_VALUE, FRAMES_DURATION)
...
- When using parallax backgrounds, due to how rendering is done, it's useful
  ...
  transition into the faded tiles.
...
- If you don't want white fade-out, set both FADE_Z values to a larger value
  than FAR_CLIP_Z.
- When the yaw value is changed, characters are turned around accordingly.
...
- Character sprite visibility is done by moving the character sprite to the
  coordinates (-10000,-10000) in order to avoid messing with sprite
  visibility and hence compatibility.
...
UltraMode7.DEFAULT_CAMERA_DISTANCE = BlizzardUtility.Numeric(_parameters["DEFAULT_CAMERA_DISTANCE"], 450);
...
UltraMode7.getCamera = function()
{
	return $gameMap.ultraMode7CameraDistance;
};

UltraMode7.setCamera = function(value)
{
...
UltraMode7.animateCamera = function(target, frameDuration)
{
...
UltraMode7.screenToMap = function(x, y)
{
	...
	var origin = new UltraMode7.Vector3(x - halfWidth, y - halfHeight, -1);
	var target = new UltraMode7.Vector3(x - halfWidth, y - halfHeight, 1);
	...
	var topLeft = modelviewMatrix.multiplied(new UltraMode7.Vector3(0, 0, 0));
	var topRight = modelviewMatrix.multiplied(new UltraMode7.Vector3(mapWidth, 0, 0));
	var bottomLeft = modelviewMatrix.multiplied(new UltraMode7.Vector3(0, mapHeight, 0));
	var bottomRight = modelviewMatrix.multiplied(new UltraMode7.Vector3(mapWidth, mapHeight, 0));
	...
	var factors = UltraMode7._solveLinearEquationWithGuassianElimination(equations);
	// create plane equation
	var ray = target.minused(origin);
	var normal = new UltraMode7.Vector3(factors[0], factors[1], factors[2]);
...
UltraMode7._solveLinearEquationWithGuassianElimination = function(M)
{
	var i;
	var j;
	var k;
...
{
	var position = new UltraMode7.Vector3(x + $gameMap.displayX() * $gameMap.tileWidth(), y + $gameMap.displayY() * $gameMap.tileHeight(), 0);
	...
	result.x = result.x * Graphics.boxWidth / 2 / vectorW + Graphics.boxWidth / 2;
	result.y = result.y * Graphics.boxHeight / 2 / vectorW + Graphics.boxHeight / 2;
	return result;
};
...
UltraMode7.Vector3 = function(x, y, z)
{
	this.x = (x || 0);
	this.y = (y || 0);
	this.z = (z || 0);
...
UltraMode7.Vector3.prototype.set = function(x, y, z)
{
	this.x = x;
	this.y = y;
	this.z = z;
...
UltraMode7.Vector3.prototype.length = function()
{
	return Math.sqrt(this.x * this.x + this.y * this.y + this.z * this.z);
};

UltraMode7.Vector3.prototype.normalize = function()
{
...
UltraMode7.Vector3.prototype.negative = function()
{
	this.x = -this.x;
	this.y = -this.y;
	this.z = -this.z;
...
UltraMode7.Vector3.prototype.multiply = function(factor)
{
	this.x *= factor;
	this.y *= factor;
	this.z *= factor;
...
UltraMode7.Vector3.prototype.plused = function(other)
{
	return new UltraMode7.Vector3(this.x + other.x, this.y + other.y, this.z + other.z);
};

UltraMode7.Vector3.prototype.minused = function(other)
{
	return new UltraMode7.Vector3(this.x - other.x, this.y - other.y, this.z - other.z);
};

UltraMode7.Vector3.prototype.averaged = function(other)
{
	return new UltraMode7.Vector3((this.x + other.x) / 2, (this.y + other.y) / 2, (this.z + other.z) / 2);
};

UltraMode7.Vector3.prototype.dotted = function(other)
{
	return (this.x * other.x + this.y * other.y + this.z * other.z);
}

UltraMode7.Vector3.prototype.crossed = function(other)
{
	return new UltraMode7.Vector3(this.y * other.z - this.z * other.y, this.z * other.x - this.x * other.z, this.x * other.y - this.y * other.x);
};
...
UltraMode7.Matrix4 = function(data)
{
	if (data)
	{
...
UltraMode7.Matrix4.prototype.setIdentity = function()
{
	this.setZero();
	this.data[0] = this.data[5] = this.data[10] = this.data[15] = 1;
};

UltraMode7.Matrix4.prototype.setZero = function()
{
	for (var i = 0; i < 16; ++i)
	{
		this.data[i] = 0;
...
UltraMode7.Matrix4.prototype.set = function(data)
{
	this.data = data.slice();
};

UltraMode7.Matrix4.prototype.setTranslation = function(vector)
{
	this.setIdentity();
...
UltraMode7.Matrix4.prototype.translate = function(x, y, z)
{
	var matrix = new UltraMode7.Matrix4();
	matrix.setTranslation(new UltraMode7.Vector3(x, y, z));
	this.multiply(matrix);
};

UltraMode7.Matrix4.prototype.rotateX = function(angle)
{
	var matrix = new UltraMode7.Matrix4();
...
UltraMode7.Matrix4.prototype.rotateY = function(angle)
{
	var matrix = new UltraMode7.Matrix4();
...
UltraMode7.Matrix4.prototype.rotateZ = function(angle)
{
	var matrix = new UltraMode7.Matrix4();
...
UltraMode7.Matrix4.prototype.setRotationX = function(angle)
{
	this.setZero();
...
UltraMode7.Matrix4.prototype.setRotationY = function(angle)
{
	this.setZero();
	var rad = BlizzardUtility.degreesToRadians(angle);
...
UltraMode7.Matrix4.prototype.setRotationZ = function(angle)
{
	this.setZero();
	var rad = BlizzardUtility.degreesToRadians(angle);
...
UltraMode7.Matrix4.prototype.multiply = function(other)
{
...
UltraMode7.Matrix4.prototype.multiplied = function(vector)
{
	return new UltraMode7.Vector3(this.data[0] * vector.x + this.data[4] * vector.y + this.data[8] * vector.z + this.data[12],
...
UltraMode7.Matrix4.prototype.lookAt = function(eye, target, up)
{
	this.setZero();
	...
	eye.negative();
	var b = new UltraMode7.Matrix4();
	b.setTranslation(eye);
	this.multiply(b);
};

UltraMode7.Matrix4.prototype.setPerspective = function(fov, width, height, nearZ, farZ)
{
	this.setZero();
...
UltraMode7.Matrix4.prototype.setOrthoProjection = function(x, y, w, h)
{
	this.setZero();
	this.data[0] = 2 / w;
	this.data[5] = 2 / h;
...
UltraMode7.Matrix4.prototype.inversed = function()
{
	...
	return new UltraMode7.Matrix4(m);
};

UltraMode7.Matrix4.prototype.determinant = function()
{
...
UltraMode7.Matrix4.prototype.transpose = function()
{
...
var UltraMode7_ShaderTilemap_prototype__updateLayerPositions = ShaderTilemap.prototype._updateLayerPositions;
ShaderTilemap.prototype._updateLayerPositions = function(startX, startY)
{
	if (!$gameMap.useUltraMode7)
	{
		UltraMode7_ShaderTilemap_prototype__updateLayerPositions.call(this, startX, startY);
	}
};
...
Game_CharacterBase.prototype.screenX = function()
{
	...
	var ultraMode7Position = UltraMode7.mapToScreen(x, y);
	return (this.isUltraMode7Visible(ultraMode7Position.z) ? ultraMode7Position.x : -10000);
};
...
Game_CharacterBase.prototype.screenY = function()
{
	...
	var x = UltraMode7_Game_CharacterBase_prototype_screenX.call(this);
	var ultraMode7Position = UltraMode7.mapToScreen(x, y);
	return (this.isUltraMode7Visible(ultraMode7Position.z) ? ultraMode7Position.y : -10000);
};
...
Game_Map.prototype.initUltraMode7 = function()
{
	...
	this._ultraMode7CameraDistance = Graphics.boxWidth / 2;
	this._ultraMode7ProjectionMatrix = new UltraMode7.Matrix4();
	this._ultraMode7ModelviewMatrix = new UltraMode7.Matrix4();
	var eye = new UltraMode7.Vector3(0, 0, this._ultraMode7CameraDistance);
	var target = new UltraMode7.Vector3(0, 0, 0);
	var up = new UltraMode7.Vector3(0, 1, 0);
...
Game_Map.prototype.setupUltraMode7 = function()
{
	...
	if ($dataMap.meta.UltraMode7 || $dataMap.meta.UltraMode7_FOV || $dataMap.meta.UltraMode7_Pitch ||
		$dataMap.meta.UltraMode7_Yaw || $dataMap.meta.UltraMode7_CameraDistance)
	{
...
Game_Map.prototype.refreshUltraMode7View = function()
{
	...
	var up = new UltraMode7.Vector3(0, 1, 0);
	this._ultraMode7ModelviewMatrix.lookAt(eye, target, up);
	this._ultraMode7ModelviewMatrix.rotateX($gameMap.ultraMode7Pitch);
	this._ultraMode7ModelviewMatrix.rotateZ($gameMap.ultraMode7Yaw);
	this._ultraMode7ModelviewMatrix.translate(-Graphics.boxWidth / 2 - $gameMap.displayX() * $gameMap.tileWidth(), -Graphics.boxHeight / 2 - $gameMap.displayY() * $gameMap.tileHeight(), 0);
};

var UltraMode7_Game_Map_prototype_parallaxOx = Game_Map.prototype.parallaxOy;
Game_Map.prototype.parallaxOx = function()
{
	...
	{
		return (this._parallaxX * UltraMode7.PARALLAX_SCROLL_X_MULTIPLIER * this.tileWidth());
	}
	if (this._parallaxLoopX)
	{
		return (this._parallaxX * UltraMode7.PARALLAX_SCROLL_X_MULTIPLIER * this.tileWidth() / 2);
	}
	return 0;
};
...
Game_Map.prototype.parallaxOy = function()
{
	...
	if (this._parallaxZero)
	{
		return (this._parallaxY * UltraMode7.PARALLAX_SCROLL_Y_MULTIPLIER * this.tileHeight());
	}
	if (this._parallaxLoopY)
	{
		return (this._parallaxY * UltraMode7.PARALLAX_SCROLL_Y_MULTIPLIER * this.tileHeight() / 2);
	}
	return 0;
};
...
Sprite_Character.prototype.characterPatternY = function()
{
	...
	var angle = $gameMap.ultraMode7Yaw;
